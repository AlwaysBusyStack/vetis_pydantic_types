...
from vetis_pydantic_types.herriot.types.production.application_ws_definitions_v2_1 import (
...
class ApplicationManagementServicePortTypeReceiveApplicationResult(
    ...
    style = "document"
    location = "https://{server}:{port}/platform/services/2.0/ApplicationManagementService"
