...
class AnimalIdstatusContentType(Enum):
    """
    Тип.
    ...
    Attributes:
        ...
        ACTIVE: Действующий (нанесенный на животное) номер
        TERMINATED: Недействующий (выбывший) номер
    """
    ...
    def verbose_name(self):
        ...
        Использование:
        AnimalIDStatusContentType.UNKNOWN.verbose_name
        """
...
class AnimalIdentityStatusContentType(Enum):
    ...
    Attributes:
        ...
        REPLACEMENT_REQUIRED: Требуется замена средства маркирования
...
class VeterinaryEventTypeContentType(Enum):
    ...
    Attributes:
        ...
        AIR: Выбытие средства маркирования для животного или группы
            животных
        RME: Перерегистрация / замена средства маркирования для
        ...
        OTH: Прочее (не классифицируемое) событие
    """
    ...
    __descriptions = {
        ...
        RME: (
            "Перерегистрация / замена средства маркирования для животного или группы "
            "животных"
        ),
        APS: "Плановый убой животного",
        ADS: "Диагностический убой животного",
